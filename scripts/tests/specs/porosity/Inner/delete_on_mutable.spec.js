describe("Deleting a property on the inner of mutable object", function() {
  ...
  describe("When the property exists", function() {
    ...
    it("Deletes the property", function () {
      expect( HasOwnProperty.call(this.$inner, "xyz") ).toBe( false )
      expect( HasOwnProperty.call(this.$outer, "xyz") ).toBe( false )
    })
  })
  ...
  describe("When the property has an assigner", function() {
    ...
    it("Deletes the property", function () {
      expect( HasOwnProperty.call(this.$inner, "mood") ).toBe( false )
      expect( HasOwnProperty.call(this.$outer, "mood") ).toBe( false )
    })
  })
  ...
  describe("When the property value matches an inherited shared property", function() {
    ...
    it("Deletes the property", function () {
      expect( HasOwnProperty.call(this.$inner, "ball") ).toBe( false )
      expect( HasOwnProperty.call(this.$outer, "ball") ).toBe( false )
    })
  })
